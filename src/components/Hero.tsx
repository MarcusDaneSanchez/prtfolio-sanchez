    ...
    <section className="hero">
      <div className="hero-content">
        ...
        <div style={{ display: 'flex', gap: '1.5rem', marginTop: '2rem' }}>
          ...
          <a href="mailto:ndrs082904@gmail.com" style={{ color: 'var(--text-primary)', transition: '0.3s', display: 'flex', alignItems: 'center' }} onMouseOver={(e) => e.currentTarget.style.color = '#EA4335'} onMouseOut={(e) => e.currentTarget.style.color = 'var(--text-primary)'}>
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
